    ...
    _createClass(ProductImageZoom, [{
      ...
      value: function _initPhotoSwipe() {
        ...
        this.slideshow.flickityInstance.cells.forEach(function (item) {
          if (item.element.classList.contains('Product__SlideItem--image') && !item.element.classList.contains('disable-zoom')) {
      ...
      value: function _initPhotoSwipeFromImageClick(event, target) {
        ...
        var images = Dom.nodeListToArray(this.element.querySelectorAll('.Product__SlideItem--image:not(.disable-zoom) img'));
        ...
        Promise.all(queries).then(function (responses) {
          ...
          Promise.all(responses.map(function (response) {
            ...
            if (window.theme.searchMode === 'product') {
              ...
              _this3.searchResultsElement.innerHTML = "<div class=\"PageLayout PageLayout--breakLap\">\n              <div class=\"PageLayout__Section\">".concat(contents[0], "</div>\n              <div class=\"PageLayout__Section PageLayout__Section--secondary\" hidden>").concat(contents[1], "</div>\n            </div>");
            }
  ...
  var CartSection = /*#__PURE__*/function () {
    ...
    _createClass(CartSection, [{
      ...
      value: function _updateItemQuantity(event, target) {
        ...
        if(target.getAttribute("data-action") == "remove-item"){
          body = JSON.stringify({
            id: target.getAttribute('data-line-id'),
            quantity: quantity
          })
        ...
        fetch("".concat(window.routes.cartChangeUrl, ".js"), {
          ...
          cart.json().then(function (content) {
            var frame_bundle_id = target.getAttribute('data-frame-bundle')
            if (frame_bundle_id) {
              fetch('/cart/change.js', {
                body: JSON.stringify({ id: frame_bundle_id, quantity: quantity }),
                credentials: 'same-origin',
                method: 'POST',
                headers: {
                  'Content-Type': 'application/json',
  ...
  var CollectionSection = /*#__PURE__*/function () {
    ...
    _createClass(CollectionSection, [{
      ...
      value: function _reloadProducts(url) {
        ...
        currentUrl.searchParams.set('section_id', this.id /*this.settings['sectionId']*/);
    ...
    _createClass(ProductSection, [{
      ...
      value: function _onScrollTargetChanged(event) {
        ...
        if (this.options['stackProductImages']) {
          ...
          if (this.slideshowNavDotsItems.length) {
